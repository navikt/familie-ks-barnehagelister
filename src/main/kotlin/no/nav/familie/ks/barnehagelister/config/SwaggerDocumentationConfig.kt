            ...
            .info(
                Info()
                    ...
                    .summary(
                        ...
                        | A confidential address may not have any address fields set | The JSON has a confidential address set to true, but also  has the address | ``` {"parameter": "kindergartens[0].address.addressOrConfidentialAddress", "detail": "A confidential address may not have any address fields set"}``` |
